...
colspecs = util.update_copy(
    AtlasDialect.colspecs, {sqltypes.LargeBinary: MixedBinary,},
)


class AtlasJDBCDialect(BaseDialect, OracleDialect):
    jdbc_db_name = "Atlas"
    jdbc_driver_name = "atlas.jdbc.AtlasDriver"
    colspecs = colspecs

    def initialize(self, connection):
        super(AtlasJDBCDialect, self).initialize(connection)
